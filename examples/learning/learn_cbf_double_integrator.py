...
def main():
    ...
    unsafe_domain: Rectangle = env.system.unsafe_domain
    state_domain: Rectangle = env.system.state_domain

    rect = plt.Rectangle(
        (unsafe_domain.lower_bounds[0], unsafe_domain.lower_bounds[1]),
        unsafe_domain.upper_bounds[0] - unsafe_domain.lower_bounds[0],
        unsafe_domain.upper_bounds[1] - unsafe_domain.lower_bounds[1],
        edgecolor="r",
        facecolor="none",
    )
    ax.add_patch(rect)
